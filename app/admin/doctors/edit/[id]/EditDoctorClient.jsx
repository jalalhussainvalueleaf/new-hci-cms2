...
export default function EditDoctorClient({ doctorId, doctor }) {
  ...
  const [formData, setFormData] = useState({
    image: doctor?.image || '',
    name: doctor?.name || '',
    category: doctor?.category || 'cardiac-sciences',
    ...
    publicationData: {
      ...
      publications: doctor?.publicationData?.publications || ['']
    },
    researchData: {
      heading: 'Research',
      research: doctor?.researchData?.research || ['']
    },
    aboutData: {
      heading: 'About',
      about: doctor?.aboutData?.about || ''
    },
    isVerified: doctor?.isVerified || false,
    isActive: doctor?.isActive !== undefined ? doctor.isActive : true,
    isFeatured: doctor?.isFeatured || false,
    reviewEnabled: doctor?.reviewEnabled || false
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: `Doctor "${data.doctor.name}" updated successfully!`,
        variant: 'success'
      });
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: error.message || 'Failed to update doctor. Please try again.'
      });
    } finally {
      setLoading(false);
    }
